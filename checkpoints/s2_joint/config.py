        ...
        transform=[
            ...
            dict(
                ...
                keys=('coord', 'origin_coord', 'grid_coord', 'segment',
                      ...
                      'child_instance', 'origin_child_instance', 'superpoint',
                      'inverse'),
...
_train_transform = [
    ...
    dict(type='CenterShift', apply_z=True),
    dict(
        type='RandomDropout', dropout_ratio=0.2,
        dropout_application_ratio=0.2),
    dict(
        type='RandomRotate', angle=[-1, 1], axis='z', center=[0, 0, 0],
        p=0.95),
    dict(type='RandomRotate', angle=[-0.015625, 0.015625], axis='x', p=0.95),
    dict(type='RandomRotate', angle=[-0.015625, 0.015625], axis='y', p=0.95),
    dict(type='RandomScale', scale=[0.9, 1.1]),
    dict(type='ChromaticAutoContrast', p=0.2, blend_factor=None),
    dict(type='ChromaticTranslation', p=0.95, ratio=0.05),
    dict(type='ChromaticJitter', p=0.95, std=0.05),
